      ...
      <div className="py-16">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            Saiye is a free, open-source project. There are no paid plans and no
            hosted cloud service — you run it on your own server, and every
            feature is included.
          </p>
        </div>
        ...
        <div className="mx-auto mt-16 max-w-3xl px-6">
          <div className="rounded-2xl border border-gray-200 bg-white p-8 text-center shadow-sm">
            ...
            <p className="mt-3 text-gray-600">
              ...
              with Docker, bring your own AI credentials, and keep full control
              of your data on your own infrastructure.
            </p>
          </div>
        </div>
      </div>
