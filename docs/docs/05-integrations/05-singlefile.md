...
:::tip
The official Saiye extension now also supports client-side crawling as an experimental feature (powered by SingleFile under the hood). If you only need to hoard pages from your own browser session, you may not need the standalone SingleFile extension anymore.
:::
...
```bash
saiye bookmarks import-singlefile page.html --url "https://example.com/page"
```
