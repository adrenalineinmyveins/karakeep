...
If you can get your bookmarks in a text file with one link per line, you can use the following command to import them using the [saiye cli](https://docs.saiye.app/command-line):
