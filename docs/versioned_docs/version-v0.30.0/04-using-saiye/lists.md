...
Lists are the core organizational layer in Saiye. Every saved item can sit in multiple lists so you can group links by project, topic, or audience without duplicating them.
