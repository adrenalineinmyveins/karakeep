...
Download the docker compose file provided [here](https://github.com/adrenalineinmyveins/karakeep/blob/main/docker/docker-compose.yml) directly into your new directory.

```
wget https://raw.githubusercontent.com/adrenalineinmyveins/karakeep/main/docker/docker-compose.yml
```
