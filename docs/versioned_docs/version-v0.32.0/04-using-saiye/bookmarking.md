...
Everything in Saiye starts as a bookmark. Here’s how the different types work and how to keep your home view tidy with favourites and archive.
...
- **Links**: URLs saved from the web or extension. Saiye grabs metadata, previews, screenshots, and archives when configured.
- **Text**: Quick notes or snippets you paste in. Great for ideas, quotes, or saving context alongside links.
- **Media**: Images or PDFs you want to save for later. Saiye automatically extracts content out of those files and makes them searchable.
