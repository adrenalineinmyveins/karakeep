...
3. Set up
    ...
    Environment variables can be set in `/etc/saiye/saiye.env` according to [configuration page](../03-configuration/01-environment-variables.md). **The environment variables that are not specified in `/etc/saiye/saiye.env` need to be added by yourself.**
...
**6. Set Saiye**  
Edit `/etc/saiye/saiye.env` according to [configuration page](../03-configuration/01-environment-variables.md). **The environment variables that are not specified in `/etc/saiye/saiye.env` need to be added by yourself.**
