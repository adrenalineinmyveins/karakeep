...
+    image: ghcr.io/adrenalineinmyveins/karakeep:${HOARDER_VERSION:-release}
```
...
If you previously used the [Debian/Ubuntu install script](../02-installation/06-debuntu.md) to install Hoarder, there is an option to migrate your installation to Saiye.
