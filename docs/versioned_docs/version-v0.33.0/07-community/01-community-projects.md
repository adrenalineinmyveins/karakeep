...
Ask questions about your Saiye bookmarks. wdoc is a Retrieval-Augmented Generation tool (CLI and Python library) that turns your saved content into a searchable, queryable knowledge base, with recently added native Saiye support on top of 20+ other filetypes.
